...
/*---------------------------------*/
/**
 * \fn void faspxx_sparse_abybms_ (INT *ia, INT *ja, INT *ib, INT *jb, INT *nap,
...
/**
 * \fn void faspxx_sparse_abyb_ (INT *ia,INT *ja, DBL *a, INT *ib, INT *jb, DBL *b,
 *                             INT *nap, INT *map, INT *mbp, INT *ic, INT *jc, DBL *c)
 *
...
/**
 * \fn void faspxx_sparse_iit_ (INT *ia, INT *ja, INT *na, INT *ma, INT *iat, INT *jat)
 *
...
/**
 * \fn void faspxx_sparse_aat_ (INT *ia, INT *ja, DBL *a, INT *na, INT *ma, INT *iat,
 *                            INT *jat, DBL *at)
 *
 * \brief Transpose a boolean matrix (only given by ia, ja)
 *
...
/**
 * \fn void void faspxx_sparse_aplbms_ (INT *ia, INT *ja, INT *ib, INT *jb,
...
/**
 * \fn void faspxx_sparse_aplusb_ (INT *ia, INT *ja, DBL *a,
 *                               INT *ib, INT *jb, DBL *b,
 *                               INT *nab, INT *mab,
 *                               INT *ic, INT *jc, DBL *c)
 *
...
/**
 * \fn void faspxx_sparse_rapms_(INT *ir, INT *jr, INT *ia, INT *ja, INT *ip, INT *jp,
...
/**
 * \fn void faspxx_sparse_wtams_(INT *jw, INT *ia, INT *ja, INT *nwp,INT *map,
...
/**
 * \fn void faspxx_sparse_wta_(INT *jw, DBL *w, INT *ia, INT *ja, DBL *a,
 *                           INT *nwp, INT *map, INT *jv, DBL *v, INT *nvp)
 *
...
/**
 * \fn void faspxx_sparse_ytxbig_ (INT *jy, DBL *y, INT *nyp, DBL *x, DBL *s)
 *
...
/**
 * \fn void faspxx_sparse_ytx_(INT *jy, DBL *y, INT *jx, DBL *x,
 *                           INT *nyp, INT *nxp, INT *icp, DBL *s)
 *
...
/**
 * \fn void faspxx_sparse_rapcmp_ (INT *ir, INT *jr, DBL *r, INT *ia, INT *ja,
 *                               DBL *a, INT *ipt, INT *jpt, DBL *pt, INT *nin,
 *                               INT *ncin, INT *iac,INT *jac, DBL *ac, INT *idummy)
 *
...
void faspxx_sparse_rapcmp_(INT* ir, INT* jr, DBL* r, INT* ia, INT* ja, DBL* a, INT* ipt,
                           ...
                           DBL* ac, INT* idummy)
{
    INT i, j, k, n, nc, nv, nw, nptjc, iacst, iacen, ic, jc, is, js, jkc, iastrt, iaend,
        ji, jia;
    DBL  aij, v0;
    INT *icp = NULL, *jv = NULL, *jris = NULL, *jptjs = NULL;
    DBL *v = NULL, *ris = NULL, *ptjs = NULL;
    n  = *nin;
    nc = *ncin;

    v   = (DBL*)calloc(n, sizeof(DBL));
...
/**
 * \fn ivector faspxx_sparse_mis (dCSRmat *A)
 *
...
ivector faspxx_sparse_mis(dCSRmat* A)
{
    ...
    INT  count = 0;
    INT* flag;
    flag = (INT*)faspxx_mem_calloc(n, sizeof(INT));
    // for (i=0;i<n;i++) flag[i]=0;
    memset(flag, 0, sizeof(INT) * n);

    // work space
    INT* work = (INT*)faspxx_mem_calloc(n, sizeof(INT));
    ...
    // form MIS
    MIS.row = count;
    work    = (INT*)faspxx_mem_realloc(work, count * sizeof(INT));
    MIS.val = work;

    // clean
    faspxx_mem_free(flag);
    flag = NULL;
