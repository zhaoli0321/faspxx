...
/**
 * \fn INT faspxx_solver_umfpack (dCSRmat *ptrA, dvector *b, dvector *u,
 *                              const SHORT prtlvl)
 *
...
#if WITH_UMFPACK
/**
 * \fn void* faspxx_umfpack_factorize (dCSRmat *ptrA, const SHORT prtlvl)
...
/**
 * \fn INT faspxx_umfpack_solve (dCSRmat *ptrA, dvector *b, dvector *u,
...
/**
 * \fn INT faspxx_umfpack_free (void *Numeric)
 * \brief Solve Au=b by UMFpack
 *
 * \param Numeric   Pointer to the numerical factorization
 *
